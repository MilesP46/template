...
export function Chat() {
  ...
  useEffect(()=> {
    ...
    async function loadConfig() {
      ...
      if (!llmModel) {  
        setLlmModel(await config?.getServerConfig('llmModelChat') as string ?? 'gpt-4o');
      }
        ...
        <DrawerHeader>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuItem onSelect={(e) => {
                ...
                setLlmModel('gpt-4o');
              }}> { llmModel === 'gpt-4o' || llmModel === '' ? <CheckIcon className="mr-2" /> : null } Chat with ChatGPT 4o</DropdownMenuItem>
          ...
          {<DropdownMenu>
            ...
            <DropdownMenuContent className="dark:bg-black bg-white">
              ...
              <DropdownMenuItem onSelect={(e) => {
                ...
                chatContext.setCrosscheckModel('gpt-4o');
                if (!chatContext.isCrossChecking) {
                  chatContext.autoCheck([...chatContext.visibleMessages], 'chatgpt', 'gpt-4o');
                }
              }}>{ chatContext.crosscheckModel === 'gpt-4o' ? <CheckIcon className="mr-2" /> : null } Check with ChatGPT</DropdownMenuItem>
              {/* <DropdownMenuItem onSelect={(e) => {
